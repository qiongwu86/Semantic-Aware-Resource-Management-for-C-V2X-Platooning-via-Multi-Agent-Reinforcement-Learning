...
def main(args):
    base_path = r'D:\Semantic-Aware-Resource-Management-for-C-V2X-Platooning-via-Multi-Agent-Reinforcement-Learning-main\DeepSC\data'

    args.input_data_dir = base_path + r'\txt\en'
    args.output_train_dir = base_path + r'\train_data.pkl'
    args.output_test_dir = base_path + r'\test_data.pkl'
    args.output_vocab = base_path + r'\vocab.json'
